          ...
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              children: [
                ...
                Text(
                  "Number of Lessons: ${snapshot.data!.numberOfLessons}",
                  style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                    fontSize: 14,
                    fontWeight: FontWeight.w900
                  )
                ...
                Wrap( 
                  ...
                  runSpacing: 8,
                  children: [
                    ...snapshot.data!.categories.map((category) => Tag(text: category))
                  ]
                ),
                SizedBox(height: 12),
                  ...
                  child: Button(
                    action: () {
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => CourseChapters(id: id, title: snapshot.data!.name))
                      );
                    }, 
                    text: "Learn"
                  )
